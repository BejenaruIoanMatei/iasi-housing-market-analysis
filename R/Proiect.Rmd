...
subtitle: "Proiect realizat in cadrul disciplinei *Introducere in R* sub coordonarea Prof. Viorica Daniela"
...
### Interval de incredere pentru pretul mediu

```{r}
t.test(df$Pret_mp)$conf.int
```

- Suntem 95% convinsi ca media reala a preturilor din Iasi se situeaza intre **1847.087** si **1894.352** eur/mp

### Exista asociere intre zona si vechimea imobilelor ?

```{r}
chisq.test(df$Tip_Zona, df$Vechime_Imobil)
```

- H0: Zona si vechimea sunt independente (gasesc la fel de multe blocuri noi in Copou cat in Galata)

- H1: Exista o asociere intre zona si vechime

Interpretare:

- p-value < 2.2e-16 < 0.05, respingem H0

- Cu un risc asumat de 5%, exista o asociere semnificativa intre tipul de zona si vechimea imobilelor

Cu ce ma ajuta ?

- In cadrul concluziei "Locatia bate vechimea": vechimea imobilelor nu este distribuita random in Iasi. Apartamentele vechi sunt in zone centrale si profita de acest lucru, in timp ce apartamentele noi sunt penalizate pentru ca sunt pe la periferia orasului.
